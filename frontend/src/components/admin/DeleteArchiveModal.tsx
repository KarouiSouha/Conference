...
export default function DeleteConfirmationModal({ isOpen, onClose, onConfirm, archiveName }) {
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600">
              Êtes-vous sûr de vouloir supprimer <span className="font-semibold">{archiveName}</span> ?
